...
const AboutPrev = ({ idProp }) => {
    return <>
        <div className="section" ><h1 id={idProp}>About Me</h1>
            <img className={styles.about_img} src={about}></img>
            <p>Hi, I am Nadia. I grew up in London with my Mum and brother and moved to East Anglia to take up Headship in 2015. I now love life in the countryside and live here with my partner and two children</p><Link to="/About">Read More</Link>
